...
public class Car {
    ...
    public Car() {
        brand = "standart";
        model = "standart";
        this.body = new Body(Color.WHITE, BodyType.SEDAN);
        this.steeringWheel = new SteeringWheel(false, 5);
        this.wheel = new Wheel(30);
    }

    public Car(String brandauto, String modelauto, Color color,BodyType bodyType, int wheelRadius, int radiusSteeringWheel, boolean buttonsOnSteeringWheel) {
