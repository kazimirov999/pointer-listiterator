...
public class Wheel {
    ...
    private String winterTyre;
    private String sunnerTyre;

    public String getSunnerTyre() {
        return sunnerTyre;
    }

    public void setSunnerTyre(String sunnerTyre) {
        this.sunnerTyre = sunnerTyre;
    }
    ...
    public String getWinterTyre() {
        return winterTyre;
    }

    public void setWinterTyre(String winterTyre) {
